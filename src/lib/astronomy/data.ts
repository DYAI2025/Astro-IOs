...
export const STARS: StarData[] = [
  ...
  { name: "Bellatrix", ra: 5.419, dec: 6.35, mag: 1.64, con: "Orion" },
  ...
  { name: "Saiph", ra: 5.796, dec: -9.67, mag: 2.06, con: "Orion" },
  // Ursa Major
  ...
  { name: "Caph", ra: 0.153, dec: 59.15, mag: 2.27, con: "Cassiopeia" },
  { name: "Gamma Cas", ra: 0.945, dec: 60.717, mag: 2.47, con: "Cassiopeia" },
  { name: "Ruchbah", ra: 1.43, dec: 60.235, mag: 2.68, con: "Cassiopeia" },
  { name: "Segin", ra: 1.907, dec: 63.67, mag: 3.38, con: "Cassiopeia" },
  // Scorpius
  { name: "Antares", ra: 16.49, dec: -26.432, mag: 0.96, con: "Scorpius" },
  { name: "Shaula", ra: 17.56, dec: -37.104, mag: 1.63, con: "Scorpius" },
  ...
  { name: "Lesath", ra: 17.53, dec: -37.296, mag: 2.69, con: "Scorpius" },
  // Leo
  { name: "Regulus", ra: 10.14, dec: 11.967, mag: 1.35, con: "Leo" },
  ...
  // Virgo
  { name: "Spica", ra: 13.42, dec: -11.161, mag: 0.97, con: "Virgo" },
  ...
  { name: "Adhara", ra: 6.977, dec: -28.972, mag: 1.5, con: "CanisMajor" },
  { name: "Wezen", ra: 7.14, dec: -26.393, mag: 1.84, con: "CanisMajor" },
  ...
  { name: "Sulafat", ra: 18.982, dec: 32.69, mag: 3.24, con: "Lyra" },
  // Cygnus
  { name: "Deneb", ra: 20.69, dec: 45.28, mag: 1.25, con: "Cygnus" },
  { name: "Sadr", ra: 20.37, dec: 40.257, mag: 2.2, con: "Cygnus" },
  { name: "Gienah", ra: 20.77, dec: 33.97, mag: 2.46, con: "Cygnus" },
  { name: "Albireo", ra: 19.512, dec: 27.96, mag: 3.18, con: "Cygnus" },
  // Aquila
  ...
  { name: "Ascella", ra: 19.043, dec: -29.88, mag: 2.59, con: "Sagittarius" },
  { name: "Kaus Media", ra: 18.35, dec: -29.828, mag: 2.7, con: "Sagittarius" },
  ...
  { name: "Dabih", ra: 20.35, dec: -14.781, mag: 3.08, con: "Capricornus" },
  // Aquarius
  { name: "Sadalsuud", ra: 21.526, dec: -5.571, mag: 2.91, con: "Aquarius" },
  { name: "Sadalmelik", ra: 22.096, dec: -0.32, mag: 2.96, con: "Aquarius" },
  // Pisces
  { name: "Eta Piscium", ra: 1.525, dec: 15.346, mag: 3.62, con: "Pisces" },
  // Aries
  { name: "Hamal", ra: 2.12, dec: 23.463, mag: 2.0, con: "Aries" },
  ...
  { name: "Mimosa", ra: 12.795, dec: -59.689, mag: 1.3, con: "Crux" },
  { name: "Gacrux", ra: 12.519, dec: -57.113, mag: 1.64, con: "Crux" },
  // Centaurus
  { name: "Alpha Centauri", ra: 14.66, dec: -60.835, mag: -0.27, con: "Centaurus" },
  { name: "Hadar", ra: 14.064, dec: -60.373, mag: 0.61, con: "Centaurus" },
  // Bootes
  { name: "Arcturus", ra: 14.261, dec: 19.182, mag: -0.05, con: "Bootes" },
  { name: "Izar", ra: 14.75, dec: 27.074, mag: 2.7, con: "Bootes" },
  // Pegasus
  ...
  { name: "Algenib", ra: 0.22, dec: 15.183, mag: 2.83, con: "Pegasus" },
  // Andromeda
  { name: "Alpheratz", ra: 0.14, dec: 29.091, mag: 2.06, con: "Andromeda" },
  { name: "Mirach", ra: 1.163, dec: 35.621, mag: 2.05, con: "Andromeda" },
  { name: "Almach", ra: 2.065, dec: 42.33, mag: 2.17, con: "Andromeda" },
  // Perseus
  ...
  { name: "Menkalinan", ra: 5.992, dec: 44.948, mag: 1.9, con: "Auriga" },
  // Ophiuchus
  { name: "Rasalhague", ra: 17.582, dec: 12.56, mag: 2.07, con: "Ophiuchus" },
  ...
  // Hercules
  { name: "Kornephoros", ra: 16.504, dec: 21.49, mag: 2.77, con: "Hercules" },
  { name: "Rasalgethi", ra: 17.244, dec: 14.39, mag: 3.37, con: "Hercules" },
  // Corona Borealis
...
export const PLANETS: Record<string, PlanetData> = {
  ...
  earth: { name: "Erde", a: 1.0, e: 0.017, i: 0.0, omega: -11.26, w: 114.21, M0: 357.53, period: 365.25, radius: 0.42, color: "#4A90D9", symbol: "\u2295" },
